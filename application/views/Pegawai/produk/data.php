...
<div class="modal fade" id="exampleModalEdit<?= $pr->id_produk ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('Pegawai/Produk/edit') ?>" method="post" enctype="multipart/form-data">
          <div class="form-group">
            <label>Kode produk</label>
            <input type="hidden" name="id" value="<?= $pr->id_produk ?>">
            <input type="text" name="kode_produk" class="form-control" value="<?= $pr->kode_produk ?>">
          </div>
          <div class="form-group">
            <label>Nama produk</label>
          ...
          <div class="form-group">
            <label>Qty</label>
            <input type="number" name="qty" class="form-control" value="<?= $pr->qty ?>">
          </div>
          <div class="form-group">
